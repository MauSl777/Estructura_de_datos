...
def iniciar_reproduccion():
	...
	barra21['value'] = random.choice(lista)
	barra22['value'] = random.choice(lista)
	barra23['value'] = random.choice(lista)
	barra24['value'] = random.choice(lista)
	barra25['value'] = random.choice(lista)
	barra26['value'] = random.choice(lista)
	barra27['value'] = random.choice(lista)
	barra28['value'] = random.choice(lista)
	barra29['value'] = random.choice(lista)
	barra30['value'] = random.choice(lista)
...
barra21 = ttk.Progressbar(frame1, orient= 'vertical', length=300,  maximum=300, style="Vertical.TProgressbar") 
barra21.grid(column=20,row=0, padx = 1)
barra22 = ttk.Progressbar(frame1, orient= 'vertical', length=300,  maximum=300, style="Vertical.TProgressbar") 
barra22.grid(column=21,row=0, padx = 1)
barra23 = ttk.Progressbar(frame1, orient= 'vertical', length=300,  maximum=300, style="Vertical.TProgressbar") 
barra23.grid(column=22,row=0, padx = 1)
barra24 = ttk.Progressbar(frame1, orient= 'vertical', length=300,  maximum=300, style="Vertical.TProgressbar") 
barra24.grid(column=23,row=0, padx = 1)
barra25 = ttk.Progressbar(frame1, orient= 'vertical', length=300,  maximum=300, style="Vertical.TProgressbar") 
barra25.grid(column=24,row=0, padx = 1)
barra26 = ttk.Progressbar(frame1, orient= 'vertical', length=300,  maximum=300, style="Vertical.TProgressbar") 
barra26.grid(column=25,row=0, padx = 1)
barra27 = ttk.Progressbar(frame1, orient= 'vertical', length=300,  maximum=300, style="Vertical.TProgressbar") 
barra27.grid(column=26,row=0, padx = 1)
barra28 = ttk.Progressbar(frame1, orient= 'vertical', length=300,  maximum=300, style="Vertical.TProgressbar") 
barra28.grid(column=27,row=0, padx = 1)
barra29 = ttk.Progressbar(frame1, orient= 'vertical', length=300,  maximum=300, style="Vertical.TProgressbar") 
barra29.grid(column=28,row=0, padx = 1)
barra30 = ttk.Progressbar(frame1, orient= 'vertical', length=300,  maximum=300, style="Vertical.TProgressbar") 
barra30.grid(column=29,row=0, padx = 1)
...
boton1 = Button(frame2, width=13, height=3, font="Helvetica 9 bold",text="Abrir archivos", command= abrir_archivo)
boton1.grid(column=0, row=2, pady=10)
boton2 = Button(frame2, bg='yellow',  width=6, height=3, font="Helvetica 9 bold",text="Play", command=iniciar)
boton2.grid(column=1, row=2, pady=10)
boton3 = Button(frame2,bg='red', width=6, height=3, font="Helvetica 9 bold",text="Stop", command=stop)
boton3.grid(column=2, row=2, pady=10)
boton4 = Button(frame2, bg='blue',width=6, height=3, font="Helvetica 9 bold",text="Pausa", command=pausa)
boton4.grid(column=3, row=2, pady=10)
boton5 = Button(frame2,  bg='green2', width=7, height=3, font="Helvetica 9 bold",text="Continuar",command=continuar)
boton5.grid(column=4, row=2, pady=10)
atras = Button(frame2,  bg='orange',width=6, height=3, font="Helvetica 9 bold",text="Anterior",command= retroceder)
atras.grid(column=5, row=2, pady=10)
adelante = Button(frame2,  bg='green',width=6, height=3, font="Helvetica 9 bold",text="Next",command=adelantar)
